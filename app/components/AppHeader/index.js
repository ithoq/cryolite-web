        ...
        <div className="header-inner header-md-height">
          ...
          <div className="d-flex align-items-center">
            ...
            <div className="dropdown pull-right">
              <button className="profile-dropdown-toggle clickable" type="button" data-toggle="dropdown"
                      aria-haspopup="true" aria-expanded="false">
                <span className="thumbnail-wrapper d32 circular inline sm-m-r-5">
                  <img src={staticImages['profiles']['avatar.jpg']}
                       alt="" data-src={staticImages['profiles']['avatar.jpg']}
                       data-src-retina={staticImages['profiles']['avatar_small2x.jpg']} width="32" height="32"/>
                </span>
              </button>
        ...
        <div className="bg-white">
          <div className="container">
            <div className="menu-bar header-sm-height d-flex justify-content-between align-content-between"
              ...
              <div className="shopping-cart dropdown d-flex justify-content-center align-content-center">
                <div id="notification-center"
                     data-toggle="dropdown" className="clickable">
                  Your Cart &nbsp;
